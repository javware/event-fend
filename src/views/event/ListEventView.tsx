...
import { ColumEventView } from "./ColumEventView"
        ...
        <div className='bg-white rounded-xl border border-gray-100 px-4 py-4 w-full'>
            <div className='flex flex-col items-center gap-3 justify-between md:flex-row relative mb-5'>
                <div className="flex flex-col text-center md:text-left">
                    <h1 className='font-semibold text-xl'>Lista de Eventos</h1>
                    <p className='text-gray-400 text-sm'>
                        Visualiza y gestiona la información de los eventos registrados.
                    </p>
                </div>
                ...
                <div className='flex gap-3'>
                    ...
                    />
                    <Link to="/event/create" className="flex items-center bg-primary py-2 px-4 rounded-full text-white  text-sm cursor-pointer">
                        Agregar
                    </Link>

                </div>
            </div>
            <Table data={tableData} columns={ColumEventView} globalFilter={globalFilter} isLoading={isLoading} />
